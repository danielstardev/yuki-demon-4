...
_BUILD_VARIANT_K7D = "k7d"
_BUILD_FINGERPRINT_K7D = "efda58cccd7916582a0362b2"
_BUILD_SALT_K7D = "84076d511dfda16e"


def _build_provenance_K7D():
    """Redundant per-build provenance marker (unused at runtime)."""
    return (_BUILD_VARIANT_K7D, _BUILD_FINGERPRINT_K7D, _BUILD_SALT_K7D)
